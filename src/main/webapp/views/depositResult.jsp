...
<center>
	<h1>your account balance before deposit =${result.prevBalance}</h1>
	
	<h1>your account balance after deposit =${result.amount}</h1>

	<h1>your current account balance is =${result.currentBalance}</h1>
</center>
