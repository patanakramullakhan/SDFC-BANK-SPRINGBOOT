...
<center>
	<h1>your account balance before deposit =${withdrawResult.prevBalance}</h1>
	
	<h1>your deposit balance  =${withdrawResult.amount}</h1>

	<h1>your current account balance is =${withdrawResult.currentBalance}</h1>
</center>
